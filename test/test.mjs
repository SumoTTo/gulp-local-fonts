...
describe( 'gulp-local-fonts', function() {
	describe( 'global', function() {
		// todo: These tests and the one below need to be corrected.
		// I commented out these tests because they started throwing exceptions, which is generally correct,
		// but they need to be intercepted in order for the test to complete correctly.
		// But now I don't have time to do it.
